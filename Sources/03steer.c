...
double sp_x1=0.0045;//0.0062//0.0060
...
//		else if(ABS(target_offset)<78)  {Steer_kp=sp_x1*(ABS(target_offset)-sp_x3)*(ABS(target_offset)-sp_x3)+sp_x2;Steer_kd=15;}//0.0111 30 4   0.00325 10 4   0.0091  20 4
