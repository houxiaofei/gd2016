...
float csxs=0.6;//差速系数
//**********************差速参数***************************/
signed int Speed_kc1=15000,Speed_kc2=1300;
...
//**********************双PID差速控制参数**********************************************;	
float KP_speed=1,KI_speed=0.01,KD_speed=0;
int Speed_Err=0,Speed_Err_his=0,Speed_Err_his2=0;
int Pwm_Delta=0;
int MotorPWM=0;
float KP_DifSpd=0.1,KI_DifSpd=0.01,KD_DifSpd=0;
...
void Speed_PID(void)
{
	...
	Pwm_Delta=KP_speed*(Speed_Err-Speed_Err_his)+KI_speed*Speed_Err+KD_speed*(Speed_Err+Speed_Err_his-2*Speed_Err_his);
	MotorPWM+=Pwm_Delta;
